...
<div class="section_gap">
		<?php foreach($get_events as $key=>$data): ?>
		<?php  if($data['post_image_name']!='no_image') {?>
		<figure>
			<img  style="max-height: 250px;"  alt="<?php echo $data['post_image_name'] ?>" src="<?php  echo base_url('site_assets/uploads/page/'); ?><?php echo $data['post_image_name']?>">
		</figure>
		<?php }?>
	<?php endforeach; ?>
		<div class="row">
